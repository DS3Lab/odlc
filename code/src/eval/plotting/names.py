...
CLASSIFIER_NAMES = {ImagenetClassifierNames.densenet121: 'DenseNet-121',
...
COMPRESSION_NAMES = {'cpm': 'Mentzer et al.',
                     'rnn': r'RNN-$\alpha$',
                     'gru0': 'RNN-C (Ours)',
...
COMPRESSION_LABELS = {'gru0': r'$\alpha=1$',
                      'gru025': r'$\alpha=0.75$',
                      'gru05': r'$\alpha=0.5$',
                      'gru075': r'$\alpha=0.25$',
                      'gru1': r'$\alpha=0$',
