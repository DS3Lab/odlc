...
# class ConvD2SGRUCell(rnn_cell_impl.RNNCell):
#     """ Convolutional Depth to space GRU cell (ConvGRU) """
#
#     def __init__(self,
#                  num_units,
#                  out_height,
...
#                  hidden_kernel_size,
#                  data_format):
#         super(ConvD2SGRUCell, self).__init__(name='ConvGRU')
#
#         self._num_units = num_units
#         self._out_height = out_height
#         self._out_width = out_width
...
#
#         # Depth to Space
#         output = tf.depth_to_space(new_state, 2, data_format=self._data_format)
#
